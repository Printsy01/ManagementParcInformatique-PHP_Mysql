<?php
  ...
  $ltp = "SELECT * FROM materiel_info_laptop" ;
  $don = $pdo -> query($ltp);
    ...
    <section class="main">
        <div class="sidebar">
            <ul class="sidebar--items">
                ...
                <li>
                    <a href="laptop.php" id="active--link">
        ...
        <div class="main--content">
            ...
            <p id="user">
                ...
                <div class="recent--patients">
                    <div class="title">
                        <h2 class="section--title">Les Laptops</h2>
                ...
                <div class="table-responsive">
                   ...
                   <?php while($row = $don->fetch(PDO::FETCH_ASSOC)) : ?>
                 

<tr>
                            
                            <td>MEI/LPTP/<?php echo $row['matl_id']; ?></td>
                            <td><?php echo ($row['user_id']); ?></td>
<?php
if(!empty($row['matl_ondu']))  {
?>

                            <td>MEI/ONDU/<?php echo $row['matl_id'] ?></td>
<?php
} else {
?>  
...
?> 
                                ...
                                <a href="delete_laptop_admin.php?user_id=<?php echo $row['matl_id']; ?>"><i class="ri-delete-bin-line delete"></i></span></a></td>
...
<div class="container mt-3">
  ...
  Bureau :    
<select class="w3-input w3-border" style='border:thin solid blue; border-radius:15px;'  value="<?php echo $row['office_id']; ?>" name="offtype" id="offtype">
  ...
  Observation :
  <p><input class="w3-input w3-border" id="obse" name="obse" type="text"  placeholder="Ajouter une observation" value="<?php echo $row['observation_l']; ?>"></p>
